...
class Dev
{
    public static function caption($parameters, $source_title, $time, $widget_number, $source_url)
    {
        ...
        $html = '<div class="d-flex sign">';

        $template = '<a href="https://usd.currencyrate.today/'.$base_currency.'" target="_blank" rel="noreferrer noopener">%1$s</a>: %2$s';
        ...
        .'<p><small>'
        .'<b class="text-center"><a href="'.$source_url.'" target="_blank" rel="noreferrer noopener nofollow">'.$source_title.'</a></b><br><br>'
