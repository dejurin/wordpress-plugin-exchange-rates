...
class Dev
{
    public static function caption($parameters, $source_title, $time, $widget_number, $source_url)
    {
        ...
        $html .= '<span title="'.__('Detailed information', Plugin::PLUGIN_SLUG).'" data-caption-id="'.Plugin::PLUGIN_SLUG.'-info-caption'.$widget_number.'" class="d-flex info caption-button">'
