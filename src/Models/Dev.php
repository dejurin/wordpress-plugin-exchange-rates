...
class Dev
{
    public static function caption($parameters, $time, $caption_id, $source_id)
    {
        ...
        $html .= '<span title="'.__('Detailed information', Plugin::PLUGIN_SLUG).'" data-caption-id="'.Plugin::PLUGIN_SLUG.'-info-caption-'.$caption_id.'" class="d-flex info '.Plugin::PLUGIN_SLUG.'-caption-button">'
        ...
        $html .= '<div id="'.Plugin::PLUGIN_SLUG.'-info-caption-'.$caption_id.'" class="'.Plugin::PLUGIN_SLUG.'-info-caption">'
              .'<p><small>'
              .'<b class="text-center"><a href="'.$source['source_url'].'" target="_blank" rel="noreferrer noopener nofollow">'.$source['name'].'</a></b><br><br>'
